                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      {item.badge && (
                        <span className="text-[9px] font-extrabold px-1.5 py-0.2 rounded bg-amber-500/20 text-amber-600 dark:text-amber-300 font-mono">
                          {item.badge}
                        </span>
                      )}
                    </div>
            ...
            {hoveredItem && (
              ...
              >
                <div>
                  ...
                  <div className="my-4 h-16 w-full rounded-2xl bg-white/70 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-700 p-2 flex items-end gap-1 justify-between">
                    {[35, 45, 40, 60, 55, 70, 65, 80, 75, 95, 85, 100].map((val, i) => (
                      <motion.div
                        key={i}
                        initial={{ height: 0 }}
                        animate={{ height: `${val}%` }}
