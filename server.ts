...
// Sign-up, sign-in, Google identity and the user exports live in
// src/server/routes/auth.ts. The user store stays here because the admin console
// and the trade routes read it too.
