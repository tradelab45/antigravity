...
// ==========================================
// These live in src/server/routes/admin.ts. The admin passkey and the active
// broadcast are owned by that router; server.ts remains the single owner of the
// user and trade stores and injects them here.
