      ...
      <div className="p-4 sm:p-5 border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.02] flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-indigo-900 via-slate-900 to-slate-950 p-0.5 shadow-md flex items-center justify-center text-white border border-indigo-500/30">
            <Zap className="w-5 h-5 text-emerald-700 dark:text-mint fill-mint/20" />
          </div>
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className={`${aiStatus.configured ? 'bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 border-emerald-500/30' : 'bg-amber-500/15 text-amber-800 dark:text-amber-300 border-amber-500/30'} text-[10px] font-black px-2.5 py-0.5 rounded-full flex items-center gap-1 border`}>
                <span className={`w-1.5 h-1.5 rounded-full ${aiStatus.configured ? 'bg-mint animate-pulse' : 'bg-amber-500'}`} />
                {aiStatus.checked ? (aiStatus.configured ? 'ONLINE AI' : 'OFFLINE GUIDE') : 'CONNECTING'}
              </span>
              <span className={`${aiStatus.searchGrounding ? 'bg-mint/15 text-emerald-800 dark:text-emerald-700 dark:text-mint border-mint/30' : 'bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-white/10'} text-[10px] font-black px-2.5 py-0.5 rounded-full flex items-center gap-1 border`}>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={isLoading}
            className="px-3 py-1.5 rounded-xl bg-mint/15 hover:bg-mint/25 border border-mint/40 text-emerald-700 dark:text-mint text-xs font-black flex items-center gap-1.5 transition-all cursor-pointer shadow-2xs"
        ...
        {messages.map((msg) => {
          ...
          return (
            ...
            >
              ...
              >
                {isUser ? <User className="w-4 h-4" /> : <Bot className="w-4 h-4 text-emerald-700 dark:text-mint" />}
              </div>
                  ...
                  <div className="mt-3.5 rounded-2xl border border-slate-200/80 dark:border-white/10 bg-slate-50 dark:bg-black/30 p-3 text-[11px] text-slate-600 dark:text-slate-400 space-y-2">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5 font-bold">
                        ...
                        <span className="text-[10px] text-emerald-700 dark:text-mint font-mono uppercase">
        ...
        {isLoading && (
          <div className="flex items-start gap-3">
            <div className="w-9 h-9 rounded-2xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-white/10 flex items-center justify-center shrink-0 shadow-xs">
              <Bot className="w-4 h-4 text-emerald-700 dark:text-mint" />
            </div>
            <div className="bg-white dark:bg-[#0c161f] border border-slate-200 dark:border-white/10 rounded-3xl rounded-tl-none p-4 sm:p-5 text-xs text-slate-600 dark:text-slate-300 flex items-center gap-3 shadow-xs font-medium">
              <span className="w-2.5 h-2.5 rounded-full bg-mint animate-bounce" />
              <span className="w-2.5 h-2.5 rounded-full bg-indigo-500 animate-bounce [animation-delay:0.2s]" />
              <span className="w-2.5 h-2.5 rounded-full bg-mint animate-bounce [animation-delay:0.4s]" />
      ...
      >
        <div className="relative flex-1 flex items-center">
          <input
            ...
            className={`w-full bg-slate-50 dark:bg-white/5 border rounded-2xl pl-4 pr-11 py-2.5 text-xs sm:text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-mint dark:focus:border-mint font-medium transition-all ${
        ...
        <button
          ...
          className="px-4 sm:px-5 py-2.5 rounded-2xl bg-slate-900 hover:bg-slate-800 dark:bg-mint dark:hover:bg-mint/90 dark:text-slate-950 disabled:opacity-40 text-white font-black text-xs sm:text-sm flex items-center gap-1.5 transition-all shadow-md cursor-pointer"
        >
