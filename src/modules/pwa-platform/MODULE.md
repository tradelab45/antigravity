...
- `PwaInstall.tsx` — moved from `src/components/PwaInstall.tsx`
- `ConnectionStatus.tsx` — moved from `src/components/ConnectionStatus.tsx`

### `utils/`

- `pwa.ts` — moved from `src/utils/pwa.ts`
