    ...
    <header className="sticky top-0 z-40 w-full max-w-full overflow-x-clip bg-white/95 text-slate-900 shadow-xs backdrop-blur-md transition-colors duration-200 dark:bg-slate-900/95 dark:text-slate-100 border-b border-slate-200 dark:border-slate-800">
      ...
      <div className="mx-auto flex w-full max-w-[1640px] min-w-0 items-center justify-between gap-2 px-3 py-2.5 sm:gap-3 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 sm:py-3.5">
        ...
        >
          ...
          <div className="hidden sm:block">
            <div className="flex items-center gap-1.5">
              ...
              <span className="bg-amber-50 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 border border-amber-300/80 dark:border-amber-700/80 text-[9px] font-black px-1.5 py-0.2 rounded-full uppercase tracking-wider shadow-2xs">
                SIMULATION
              </span>
            </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <motion.button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-blue-50 dark:bg-emerald-950/40 hover:bg-blue-100 dark:hover:bg-emerald-900/60 text-blue-700 dark:text-[#00f59b] border border-blue-200 dark:border-emerald-500/30 shadow-xs transition-all cursor-pointer text-xs font-black"
            title="Switch to Admin Dashboard (Surveillance, Live Trades & User Profiles)"
          >
                ...
                >
                  ...
                  <div className="p-1.5 space-y-0.5">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-bold text-emerald-600 dark:text-[#00f59b] hover:bg-emerald-50 dark:hover:bg-emerald-950/40 transition-colors cursor-pointer"
                    >
                      <div className="flex items-center gap-2">
                        <ShieldCheck className="w-4 h-4 text-emerald-600 dark:text-[#00f59b]" />
      ...
      <div className="hidden lg:block bg-slate-50/60 dark:bg-slate-900/60 backdrop-blur-xs px-4">
        <div className="max-w-[1640px] mx-auto flex items-center justify-end gap-4 md:gap-8 py-1.5 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <nav className="relative flex items-center justify-end gap-1.5 overflow-x-auto scrollbar-none py-1 px-1 rounded-2xl bg-transparent border-0 border-transparent shadow-none outline-none">
            {navItems.map((item) => {
              ...
              return (
                <motion.button
                  ...
                  className={`relative flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-black transition-all cursor-pointer select-none overflow-hidden outline-none focus:outline-none focus:ring-0 border-0 ${
                    isActive
                      ? item.highlight
                ...
                >
                  ...
                  <Icon className={`relative z-10 w-3.5 h-3.5 transition-transform group-hover:scale-110 ${
                    isActive 
                      ? 'text-white' 
                      : item.highlight 
                  ...
                  {item.badge && (
                    <span className={`relative z-10 text-[9px] font-black px-1.5 py-0.2 rounded-full border ${
                      isActive 
          ...
          >
            ...
            <span className="bg-amber-400/30 text-amber-200 text-[9px] font-black px-1.5 py-0.2 rounded-full border border-amber-300/40 uppercase">
              VS
            </span>
          </motion.button>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            >
              ...
              <span className="bg-amber-400/30 text-amber-200 text-[9px] font-black px-1.5 py-0.2 rounded-full uppercase">
                VS
              </span>
            </button>
